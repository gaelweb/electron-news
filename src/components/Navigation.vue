    ...
    <v-navigation-drawer class="navigation-electron" :mini-variant.sync="mini" v-model="drawer" stateless hide-overlay>
        <v-toolbar flat>
          <v-list class="pa-0">
            <v-list-tile avatar>
              <v-list-tile-avatar>                
                  <img src="../assets/Kactus_logo.png">                  
              </v-list-tile-avatar>
              <v-list-tile-content>
                <router-link to="/">
                  <v-list-tile-title>K-actus</v-list-tile-title>
                </router-link>
              </v-list-tile-content>
              <v-list-tile-action>
        ...
        <v-list class="pt-0">
          <v-divider></v-divider>
          <v-list-tile v-for="(item, index) in items" :key="index" @click.prevent>
            <v-list-tile-action>
              <v-icon :id="'icon_select'+ index">{{ item.icon }}</v-icon>
            </v-list-tile-action>
            <v-list-tile-content>
                <v-list-tile-title id="link_select">
